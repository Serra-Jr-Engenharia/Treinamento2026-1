function Moldure({ poster, titulo, ano, genero }) {

    const tamanhoTitulo = titulo.length > 20 ? 'text-[14px]' : titulo.length > 12 ? 'text-[17px]' : 'text-[20px]';

  return (
    <div className="bg-primary rounded-[22px] w-full max-w-[228px] pt-[16px] flex flex-col items-center hover:-translate-y-1 hover:shadow-lg hover:shadow-orange-300 transition-transform group cursor-pointer">
